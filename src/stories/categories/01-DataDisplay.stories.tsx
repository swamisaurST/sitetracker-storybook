    ...
    components={[
      {
        ...
        status: "built", reusable: true, usages: 69,
      ...
      },
      {
        ...
        description: "High-usage component (~46 file refs). Card wrapper with batch inline editing, column visibility manager, skeleton loading, live refresh poller, and Save/Cancel flow.",
        status: "built", reusable: true, usages: 46,
      ...
      },
      {
        ...
        status: "built", reusable: true, usages: 6,
      ...
      },
      {
        ...
        status: "built", reusable: true, usages: 41,
